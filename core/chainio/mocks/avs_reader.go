...
import (
	...
	contractERC20Mock "github.com/medalex/mfssia-eigenlayer/contracts/bindings/ERC20Mock"
...
func (m *MockAvsReaderer) CheckSignatures(arg0 context.Context, arg1 [32]byte, arg2 []byte, arg3 uint32, arg4 contractMfssiaTaskManager.IBLSSignatureCheckerNonSignerStakesAndSignature) (contractMfssiaTaskManager.IBLSSignatureCheckerQuorumStakeTotals, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckSignatures", arg0, arg1, arg2, arg3, arg4)
	ret0, _ := ret[0].(contractMfssiaTaskManager.IBLSSignatureCheckerQuorumStakeTotals)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
