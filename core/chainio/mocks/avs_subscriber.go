...
import (
	...
	contractIncredibleSquaringTaskManager "github.com/medalex/mfssia-eigenlayer/contracts/bindings/MfssiaTaskManager"
...
func (m *MockAvsSubscriberer) ParseTaskResponded(arg0 types.Log) (*contractIncredibleSquaringTaskManager.ContractMfssiaTaskManagerTaskResponded, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParseTaskResponded", arg0)
	ret0, _ := ret[0].(*contractIncredibleSquaringTaskManager.ContractMfssiaTaskManagerTaskResponded)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAvsSubscriberer) SubscribeToNewTasks(arg0 chan *contractIncredibleSquaringTaskManager.ContractMfssiaTaskManagerNewTaskCreated) event.Subscription {
	m.ctrl.T.Helper()
...
func (m *MockAvsSubscriberer) SubscribeToTaskResponses(arg0 chan *contractIncredibleSquaringTaskManager.ContractMfssiaTaskManagerTaskResponded) event.Subscription {
	m.ctrl.T.Helper()
